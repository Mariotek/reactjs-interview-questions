...
3.  ### JSX چیه؟
    ...
    _JSX_ یه افزونه با سینتکسی شبیه به XML برای ECMAScript است (مخفف _Javascript XML_). اگه بخوایم ساده بگیم وظیفه اش اینه که سینتکسی ساده تر از `React.createElement` در اختیارتون قرار میده، شما میتونید Javascript رو در کنار ساختاری شبیه به HTML داشته باشید.
...
4.  ### تفاوت‌های Element و Component چیه؟
    ...
    _Element_ یک شی ساده است که وظیفه داره اون چیزی که روی صفحه نمایش داده میشه رو توصیف کنه، حالا ممکنه به صورت یک DOM node باشه یا به صورت componentهای دیگه. _Element_ ها میتونن شامل _Element_ های دیگه به عنوان props باشند. ساختن یک Element در React کار ساده و کم دردسریه اما وقتی که ساخته شد هیچ وقت نمیشه تغییرش داد.
...
</div>ها و اعداد رو به عنوان گره متنی توی DOM رندر میکنه.
     5. **‌Boolean یا null** چیزی رندر نمیکنه اما از این type برای رندر کردن محتوای شرطی استفاده میشه.
